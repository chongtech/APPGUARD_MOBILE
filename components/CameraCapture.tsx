...
export function CameraCapture({
  ...
  const handlePhoto = async () => {
    ...
    try {
      ...
      logger.warn(LogCategory.MEDIA, "CameraCapture: takePicture failed", {
        error: String(error),
      });
    } finally {
      setCapturing(false);
