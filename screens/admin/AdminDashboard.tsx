...
const NAV_LINKS: {
  ...
  {
    label: "Erros de Dispositivo",
    screen: "AdminDeviceRegistrationErrors",
    icon: "x-circle",
  },
];
...
export default function AdminDashboard() {
  ...
  const load = useCallback(async (silent = false) => {
    ...
    try {
      ...
      logger.warn(LogCategory.UI, "AdminDashboard: load failed", {
    ...
    ? [
        {
          ...
          sub: `${stats.activeCondominiums} ativos`,
          icon: "building",
          color: "#3B82F6",
        },
        {
          ...
          sub: `${stats.activeDevices} ativos`,
          icon: "tablet",
          color: "#64748B",
        },
        {
        ...
        },
        {
          ...
          sub: `${stats.pendingVisits} pendentes`,
          icon: "list",
          color: "#3B82F6",
        },
        {
        ...
        >
          ...
          <View style={styles.grid}>
            {statCards.map((c) => (
              ...
              >
                <View
                  style={[styles.iconBox, { backgroundColor: c.color + "18" }]}
                >
