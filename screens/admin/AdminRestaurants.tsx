...
export default function AdminRestaurants() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      setItems(await api.adminGetAllRestaurants());
    } catch (loadError) {
      logger.warn(LogCategory.UI, "AdminRestaurants: load failed", {
        ...
        <View style={styles.overlay}>
          ...
          >
            <View style={styles.sheetHeader}>
              <ThemedText type="h3">
                {editing ? "Editar" : "Novo Restaurante"}
              </ThemedText>
                    ...
                    <Pressable
                      ...
                      style={[
                        styles.chip,
                        {
                          ...
                          borderColor:
                            status === s ? BrandColors.primary : theme.border,
                        },
                      ]}
                      onPress={() => setStatus(s)}
                    >
