...
export default function AdminSubscriptions() {
  ...
  const load = useCallback(async (silent = false) => {
    ...
    try { setItems(await api.adminGetCondominiumSubscriptions()); } catch (loadError) { logger.warn(LogCategory.UI, "AdminSubscriptions: load failed", { error: String(loadError) }); } finally { setLoading(false); setRefreshing(false); }
  }, []);
